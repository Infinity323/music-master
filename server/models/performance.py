...
class Performance(db.Model):
    ...
    def __init__(self, id: int, sheet_music_id: int, run_number: int, date_time, tempo_percent_accuracy: float, average_tempo: int, tuning_percent_accuracy: float, dynamics_percent_accuracy: float):
        self.id = id
